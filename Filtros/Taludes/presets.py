...
def fosEvaluationCoarse(h, hw, alpha, c, phi, theta_i):
...
SOIL_MATERIALS = {
    Soils.COARSE :          COARSE       ,
    Soils.GRANULAR_MEDIUM : GRANULAR_MEDIUM,
    Soils.GRANULAR_FINE :   GRANULAR_FINE,
    Soils.MEDIUM :          MEDIUM      ,
    Soils.MEDIUM_FINE :     MEDIUM_FINE ,
    Soils.FINE :            FINE        ,
    Soils.VERY_FINE :       VERY_FINE   ,

    }

SOIL_FUNCTIONS = {
    Soils.COARSE :          lambda clay, sand, silt: clay <= 18 and sand >= 65       ,      
    Soils.GRANULAR_MEDIUM : lambda clay, sand, silt: clay <= 18 and 15 <= sand <= 65 ,
    Soils.GRANULAR_FINE :   lambda clay, sand, silt: clay <= 18 and sand <= 15       ,
    Soils.MEDIUM :          lambda clay, sand, silt: 18 <= clay <= 35 and sand >= 15 ,
    Soils.MEDIUM_FINE :     lambda clay, sand, silt: 18 <= clay <= 35 and sand <= 15 ,
    Soils.FINE :            lambda clay, sand, silt: 35 <= clay <= 60                ,
    Soils.VERY_FINE :       lambda clay, sand, silt: clay > 60                       ,
    }

DEFAULT_SOILS : dict[Soils, dict] = {
    Soils.COARSE          : {'clay': 15, 'sand': 70, 'silt':15 },
...
SOIL_THETAI = {
    Soils.COARSE :          THETAI_COARSE,
    Soils.GRANULAR_MEDIUM : THETAI_GRANULAR_MEDIUM,
    Soils.GRANULAR_FINE :   THETAI_GRANULAR_FINE,
    Soils.MEDIUM :          THETAI_MEDIUM,
    Soils.MEDIUM_FINE :     THETAI_MEDIUM_FINE,
    Soils.FINE :            THETAI_FINE,
    Soils.VERY_FINE :       THETAI_VERY_FINE,
    }

 
FOS_SOIL_FUNCTIONS = {
    Soils.COARSE :          fosEvaluationCoarse,
    Soils.GRANULAR_MEDIUM : fosEvaluationGranularMedium,
    Soils.GRANULAR_FINE :   fosEvaluationGranularFine,
    Soils.MEDIUM :          fosEvaluationMedium,
    Soils.MEDIUM_FINE :     fosEvaluationMediumFine,
    Soils.FINE :            fosEvaluationFine,
    Soils.VERY_FINE :       fosEvaluationVeryFine,
    }
