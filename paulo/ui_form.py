...
class Ui_AppTaludes(object):
    def setupUi(self, AppTaludes):
        ...
        self.gridLayout_5.addWidget(self.botao_regiao11, 2, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao12, 2, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao6, 1, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao15, 2, 4, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao5, 0, 4, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao10, 1, 4, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao7, 1, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao4, 0, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao9, 1, 3, 1, 1)
        ...
        self.botao_regiao3.setStyleSheet(u"QPushButton {background-color: rgba(255, 255, 255, 0);border: none;}\n"
"QPushButton:pressed {background-color: rgba(100, 150, 200, 0.5);}")

        self.gridLayout_5.addWidget(self.botao_regiao3, 0, 2, 1, 1)
        ...
        self.botao_regiao2.setStyleSheet(u"QPushButton {background-color: rgba(255, 255, 255, 0);border: none;}\n"
"QPushButton:pressed {background-color: rgba(100, 150, 200, 0.5);}")

        self.gridLayout_5.addWidget(self.botao_regiao2, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao14, 2, 3, 1, 1)
        ...
        self.botao_regiao1.setStyleSheet(u"QPushButton {background-color: rgba(255, 255, 255, 0);border: none;}\n"
"QPushButton:pressed {background-color: rgba(100, 150, 200, 0.5);}")

        self.gridLayout_5.addWidget(self.botao_regiao1, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.botao_regiao13, 2, 2, 1, 1)

        self.botao_regiao16 = QPushButton(AppTaludes)
        self.botao_regiao16.setObjectName(u"botao_regiao16")
        sizePolicy.setHeightForWidth(self.botao_regiao16.sizePolicy().hasHeightForWidth())
        self.botao_regiao16.setSizePolicy(sizePolicy)

        self.gridLayout_5.addWidget(self.botao_regiao16, 3, 0, 1, 1)

        self.botao_regiao17 = QPushButton(AppTaludes)
        self.botao_regiao17.setObjectName(u"botao_regiao17")
        sizePolicy.setHeightForWidth(self.botao_regiao17.sizePolicy().hasHeightForWidth())
        self.botao_regiao17.setSizePolicy(sizePolicy)

        self.gridLayout_5.addWidget(self.botao_regiao17, 3, 1, 1, 1)

        self.botao_regiao18 = QPushButton(AppTaludes)
        self.botao_regiao18.setObjectName(u"botao_regiao18")
        sizePolicy.setHeightForWidth(self.botao_regiao18.sizePolicy().hasHeightForWidth())
        self.botao_regiao18.setSizePolicy(sizePolicy)

        self.gridLayout_5.addWidget(self.botao_regiao18, 3, 2, 1, 1)

        self.botao_regiao19 = QPushButton(AppTaludes)
        self.botao_regiao19.setObjectName(u"botao_regiao19")
        sizePolicy.setHeightForWidth(self.botao_regiao19.sizePolicy().hasHeightForWidth())
        self.botao_regiao19.setSizePolicy(sizePolicy)

        self.gridLayout_5.addWidget(self.botao_regiao19, 3, 3, 1, 1)

        self.botao_regiao20 = QPushButton(AppTaludes)
        self.botao_regiao20.setObjectName(u"botao_regiao20")
        sizePolicy.setHeightForWidth(self.botao_regiao20.sizePolicy().hasHeightForWidth())
        self.botao_regiao20.setSizePolicy(sizePolicy)

        self.gridLayout_5.addWidget(self.botao_regiao20, 3, 4, 1, 1)


        self.gridLayout_4.addLayout(self.gridLayout_5, 6, 0, 3, 2)
        ...
        self.gridLayout_4.addWidget(self.label_mapa_rio, 6, 0, 3, 2)

        self.horizontalLayout_10 = QHBoxLayout()
        self.horizontalLayout_10.setObjectName(u"horizontalLayout_10")
        self.horizontalLayout_10.setContentsMargins(-1, 15, -1, -1)
        self.mapaRio_Button = QPushButton(AppTaludes)
        self.mapaRio_Button.setObjectName(u"mapaRio_Button")
        sizePolicy1 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.mapaRio_Button.sizePolicy().hasHeightForWidth())
        self.mapaRio_Button.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.corteArquivo_label.sizePolicy().hasHeightForWidth())
        self.corteArquivo_label.setSizePolicy(sizePolicy2)
        ...
        self.corteArquivo_label.setTextFormat(Qt.AutoText)
        self.corteArquivo_label.setScaledContents(True)
        self.corteArquivo_label.setAlignment(Qt.AlignCenter)
        self.corteArquivo_label.setWordWrap(True)

        self.horizontalLayout_10.addWidget(self.corteArquivo_label)
        ...
        sizePolicy3.setHeightForWidth(self.nome_arquivo_corte.sizePolicy().hasHeightForWidth())
        self.nome_arquivo_corte.setSizePolicy(sizePolicy3)
        ...
        self.horizontalLayout_10.addWidget(self.nome_arquivo_corte)
        ...
        self.horizontalLayout_10.addWidget(self.recortar_Button)
        ...
        sizePolicy4.setHeightForWidth(self.label_areia.sizePolicy().hasHeightForWidth())
        self.label_areia.setSizePolicy(sizePolicy4)
        font = QFont()
        ...
        sizePolicy5.setHeightForWidth(self.lineEdit_areia.sizePolicy().hasHeightForWidth())
        self.lineEdit_areia.setSizePolicy(sizePolicy5)
        self.lineEdit_areia.setFont(font)
        self.lineEdit_areia.setFocusPolicy(Qt.StrongFocus)
        self.lineEdit_areia.setAutoFillBackground(True)
        self.lineEdit_areia.setFrame(True)
        self.lineEdit_areia.setAlignment(Qt.AlignCenter)
        self.lineEdit_areia.setClearButtonEnabled(False)
        ...
        sizePolicy4.setHeightForWidth(self.label_argila.sizePolicy().hasHeightForWidth())
        self.label_argila.setSizePolicy(sizePolicy4)
        ...
        self.horizontalLayout_9.addWidget(self.label_argila)

        self.lineEdit_argila = QLineEdit(AppTaludes)
        self.lineEdit_argila.setObjectName(u"lineEdit_argila")
        sizePolicy5.setHeightForWidth(self.lineEdit_argila.sizePolicy().hasHeightForWidth())
        self.lineEdit_argila.setSizePolicy(sizePolicy5)
        self.lineEdit_argila.setFont(font)
        self.lineEdit_argila.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_9.addWidget(self.lineEdit_argila)
        ...
        sizePolicy4.setHeightForWidth(self.label_silte.sizePolicy().hasHeightForWidth())
        self.label_silte.setSizePolicy(sizePolicy4)
        ...
        self.label_silte.setWordWrap(False)

        self.horizontalLayout_7.addWidget(self.label_silte)

        self.label_silte2 = QLabel(AppTaludes)
        self.label_silte2.setObjectName(u"label_silte2")
        sizePolicy5.setHeightForWidth(self.label_silte2.sizePolicy().hasHeightForWidth())
        self.label_silte2.setSizePolicy(sizePolicy5)
        self.label_silte2.setFont(font)
        self.label_silte2.setAutoFillBackground(True)
        self.label_silte2.setFrameShape(QFrame.Panel)
        self.label_silte2.setScaledContents(True)
        self.label_silte2.setAlignment(Qt.AlignCenter)
        self.label_silte2.setWordWrap(True)

        self.horizontalLayout_7.addWidget(self.label_silte2)


        self.verticalLayout_5.addLayout(self.horizontalLayout_7)

        self.label_material = QLabel(AppTaludes)
        self.label_material.setObjectName(u"label_material")
        sizePolicy4.setHeightForWidth(self.label_material.sizePolicy().hasHeightForWidth())
        self.label_material.setSizePolicy(sizePolicy4)
        self.label_material.setFont(font)
        self.label_material.setMouseTracking(True)
        self.label_material.setAutoFillBackground(True)
        self.label_material.setFrameShape(QFrame.Panel)
        self.label_material.setScaledContents(True)
        self.label_material.setAlignment(Qt.AlignCenter)
        self.label_material.setWordWrap(True)

        self.verticalLayout_5.addWidget(self.label_material)
        ...
        self.ClineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.gridLayout.addLayout(self.c_phi_Layout, 1, 3, 1, 1)
        ...
        self.prop_Button = QPushButton(AppTaludes)
        self.prop_Button.setObjectName(u"prop_Button")
        sizePolicy3.setHeightForWidth(self.prop_Button.sizePolicy().hasHeightForWidth())
        self.prop_Button.setSizePolicy(sizePolicy3)

        self.btnLayout.addWidget(self.prop_Button)

        self.AnalysisBtn = QPushButton(AppTaludes)
        self.AnalysisBtn.setObjectName(u"AnalysisBtn")
        sizePolicy3.setHeightForWidth(self.AnalysisBtn.sizePolicy().hasHeightForWidth())
        self.AnalysisBtn.setSizePolicy(sizePolicy3)

        self.btnLayout.addWidget(self.AnalysisBtn)

        self.ClearBtn = QPushButton(AppTaludes)
        self.ClearBtn.setObjectName(u"ClearBtn")
        sizePolicy3.setHeightForWidth(self.ClearBtn.sizePolicy().hasHeightForWidth())
        self.ClearBtn.setSizePolicy(sizePolicy3)

        self.btnLayout.addWidget(self.ClearBtn)

        self.horizontalLayout_8 = QHBoxLayout()
        self.horizontalLayout_8.setObjectName(u"horizontalLayout_8")
        self.pLbl = QLabel(AppTaludes)
        self.pLbl.setObjectName(u"pLbl")
        sizePolicy4.setHeightForWidth(self.pLbl.sizePolicy().hasHeightForWidth())
        self.pLbl.setSizePolicy(sizePolicy4)
        self.pLbl.setFont(font)
        self.pLbl.setMouseTracking(True)
        self.pLbl.setFrameShape(QFrame.Panel)
        self.pLbl.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_8.addWidget(self.pLbl)

        self.plineEdit = QLineEdit(AppTaludes)
        self.plineEdit.setObjectName(u"plineEdit")

        self.horizontalLayout_8.addWidget(self.plineEdit)


        self.btnLayout.addLayout(self.horizontalLayout_8)


        self.gridLayout.addLayout(self.btnLayout, 1, 5, 1, 1)
        ...
        self.gridLayout.addLayout(self.h_hw_Layout, 1, 2, 1, 1)

        self.rain_Layout = QGridLayout()
        self.rain_Layout.setObjectName(u"rain_Layout")
        self.rain_Layout.setContentsMargins(10, -1, 10, -1)
        self.horizontalLayout_11 = QHBoxLayout()
        self.horizontalLayout_11.setObjectName(u"horizontalLayout_11")
        self.tLbl = QLabel(AppTaludes)
        self.tLbl.setObjectName(u"tLbl")
        sizePolicy4.setHeightForWidth(self.tLbl.sizePolicy().hasHeightForWidth())
        self.tLbl.setSizePolicy(sizePolicy4)
        self.tLbl.setFont(font)
        self.tLbl.setMouseTracking(True)
        self.tLbl.setFrameShape(QFrame.Panel)
        self.tLbl.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_11.addWidget(self.tLbl)

        self.tlineEdit = QLineEdit(AppTaludes)
        self.tlineEdit.setObjectName(u"tlineEdit")

        self.horizontalLayout_11.addWidget(self.tlineEdit)


        self.rain_Layout.addLayout(self.horizontalLayout_11, 1, 0, 1, 1)

        self.horizontalLayout_3 = QHBoxLayout()
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.thetaLbl = QLabel(AppTaludes)
        self.thetaLbl.setObjectName(u"thetaLbl")
        sizePolicy4.setHeightForWidth(self.thetaLbl.sizePolicy().hasHeightForWidth())
        self.thetaLbl.setSizePolicy(sizePolicy4)
        self.thetaLbl.setFont(font)
        self.thetaLbl.setMouseTracking(True)
        self.thetaLbl.setAutoFillBackground(True)
        self.thetaLbl.setFrameShape(QFrame.Panel)
        self.thetaLbl.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_3.addWidget(self.thetaLbl)

        self.thetalineEdit = QLineEdit(AppTaludes)
        self.thetalineEdit.setObjectName(u"thetalineEdit")

        self.horizontalLayout_3.addWidget(self.thetalineEdit)


        self.rain_Layout.addLayout(self.horizontalLayout_3, 3, 0, 1, 1)

        self.horizontalSlider_Theta = QSlider(AppTaludes)
        self.horizontalSlider_Theta.setObjectName(u"horizontalSlider_Theta")
        self.horizontalSlider_Theta.setAutoFillBackground(True)
        self.horizontalSlider_Theta.setMinimum(188)
        self.horizontalSlider_Theta.setMaximum(412)
        self.horizontalSlider_Theta.setSingleStep(0)
        self.horizontalSlider_Theta.setPageStep(0)
        self.horizontalSlider_Theta.setValue(188)
        self.horizontalSlider_Theta.setSliderPosition(188)
        self.horizontalSlider_Theta.setOrientation(Qt.Horizontal)
        self.horizontalSlider_Theta.setTickPosition(QSlider.TicksBelow)
        self.horizontalSlider_Theta.setTickInterval(20)

        self.rain_Layout.addWidget(self.horizontalSlider_Theta, 4, 0, 1, 1)

        self.horizontalSlider_t = QSlider(AppTaludes)
        self.horizontalSlider_t.setObjectName(u"horizontalSlider_t")
        self.horizontalSlider_t.setOrientation(Qt.Horizontal)
        self.horizontalSlider_t.setTickPosition(QSlider.TicksBelow)

        self.rain_Layout.addWidget(self.horizontalSlider_t, 2, 0, 1, 1)


        self.gridLayout.addLayout(self.rain_Layout, 1, 4, 1, 1)


        self.gridLayout_4.addLayout(self.gridLayout, 27, 0, 1, 2)
...
"background-color: rgb(190, 190, 190);")
        ...
        self.gridLayout_4.addLayout(self.gridLayout_3, 23, 0, 2, 2)
        ...
        sizePolicy6.setHeightForWidth(self.x1label.sizePolicy().hasHeightForWidth())
        self.x1label.setSizePolicy(sizePolicy6)
        self.x1label.setFont(font1)
        ...
        sizePolicy1.setHeightForWidth(self.y1lineEdit.sizePolicy().hasHeightForWidth())
        self.y1lineEdit.setSizePolicy(sizePolicy1)
        ...
        sizePolicy6.setHeightForWidth(self.x2label.sizePolicy().hasHeightForWidth())
        self.x2label.setSizePolicy(sizePolicy6)
        self.x2label.setFont(font1)
        ...
        sizePolicy1.setHeightForWidth(self.y2lineEdit.sizePolicy().hasHeightForWidth())
        self.y2lineEdit.setSizePolicy(sizePolicy1)
        ...
        sizePolicy6.setHeightForWidth(self.y1label.sizePolicy().hasHeightForWidth())
        self.y1label.setSizePolicy(sizePolicy6)
        self.y1label.setFont(font1)
        ...
        sizePolicy1.setHeightForWidth(self.x1lineEdit.sizePolicy().hasHeightForWidth())
        self.x1lineEdit.setSizePolicy(sizePolicy1)
        ...
        sizePolicy6.setHeightForWidth(self.y2label.sizePolicy().hasHeightForWidth())
        self.y2label.setSizePolicy(sizePolicy6)
        self.y2label.setFont(font1)
        ...
        sizePolicy1.setHeightForWidth(self.x2lineEdit.sizePolicy().hasHeightForWidth())
        self.x2lineEdit.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_4.addLayout(self.gridLayout_2, 25, 0, 1, 2)
    ...
    def retranslateUi(self, AppTaludes):
        ...
        self.botao_regiao16.setText("")
        self.botao_regiao17.setText("")
        self.botao_regiao18.setText("")
        self.botao_regiao19.setText("")
        ...
        self.lineEdit_areia.setText(QCoreApplication.translate("AppTaludes", u"0", None))
        self.lineEdit_areia.setPlaceholderText(QCoreApplication.translate("AppTaludes", u"0", None))
        self.label_argila.setText(QCoreApplication.translate("AppTaludes", u"Argila (%)", None))
        self.lineEdit_argila.setText(QCoreApplication.translate("AppTaludes", u"0", None))
        self.lineEdit_argila.setPlaceholderText(QCoreApplication.translate("AppTaludes", u"0", None))
        self.label_silte.setText(QCoreApplication.translate("AppTaludes", u"Silte (%)", None))
        self.label_silte2.setText(QCoreApplication.translate("AppTaludes", u"100", None))
        self.label_material.setText(QCoreApplication.translate("AppTaludes", u"GRANULAR FINE", None))
        ...
        self.prop_Button.setText(QCoreApplication.translate("AppTaludes", u"Propriedades", None))
        ...
        self.pLbl.setText(QCoreApplication.translate("AppTaludes", u"p (mm/h)", None))
        ...
        self.tLbl.setText(QCoreApplication.translate("AppTaludes", u"t (h)", None))
        self.thetaLbl.setText(QCoreApplication.translate("AppTaludes", u"\u03b8 (-)", None))
