...
class AppTaludes(QWidget):
    ...
    def runAnalysis(self):
        ...
        if self.number_of_adjusts >= 1:
            ...
            ax.plot_surface(x.transpose(), y.transpose(), z.transpose(), facecolors= plt.cm.rainbow_r(norm1(self.fos_array2.transpose())), antialiased=False, shade=False)
    ...
    def runAnalysis2(self):
        ...
        if self.number_of_adjusts >= 1:
            ...
            ax.plot_surface(y.transpose()[5:x2,], x.transpose()[5:x2,], z.transpose()[5:x2, 0:y2-3], facecolors= plt.cm.rainbow_r(norm1(self.fos_array.transpose()[5:x2, 0:y2-3])), antialiased=False, shade=False)
    ...
    def elev_incl(self,arquivo):
        ...
        pl = pv.Plotter(window_size=[1000, 1000], off_screen=True,image_scale=2)
        #pl.(image_scale=2)
        ...
        self.plotter.setMinimumSize(750, 620)
