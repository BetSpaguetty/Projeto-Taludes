...
class ToolBarFOS(DDScrollWidget):
    ...
    def __init__(self):
        ...
        self.mainBoxLayout.setContentsMargins(5,5,5,5)
        self.mainBoxLayout.setAlignment(Qt.AlignTop)
        self.mainBox.setLayout(self.mainBoxLayout)
        self.mainBox.setObjectName('boxMain')
        self.labelTitulo = QLabel('FOS')
        self.labelTitulo.setObjectName('title')
        self.mainBoxLayout.addWidget(self.labelTitulo)
        self.setStyleSheet(QSS_TOOLSBAR)


    def addOnToolsBar(self, widget: QWidget) :
        self.mainBoxLayout.addWidget(widget)
    

    def addBox(self, title) :
        box = OptionToolsBar(title)
        self.addOnToolsBar(box)
        return box
...
class OptionToolsBar(QWidget) :
    ...
    def __init__(self, titulo:str):
        ...
        self.areaOcultaLayout.setAlignment(Qt.AlignTop)
...
class SubEditor(DDWidget) :
    ...
    def createSlider(self, min, max) -> QSlider:
