...
SOIL_FUNCTIONS = {
    Materiais.COARSE :          lambda clay, sand, silt: clay <= 18 and sand >= 65       ,      
    Materiais.GRANULAR_MEDIUM : lambda clay, sand, silt: clay <= 18 and 15 <= sand <= 65 ,
    Materiais.GRANULAR_FINE :   lambda clay, sand, silt: clay <= 18 and sand <= 15       ,
    Materiais.MEDIUM :          lambda clay, sand, silt: 18 <= clay <= 35 and sand >= 15 ,
    Materiais.MEDIUM_FINE :     lambda clay, sand, silt: 18 <= clay <= 35 and sand <= 15 ,
    Materiais.FINE :            lambda clay, sand, silt: 35 <= clay <= 60                ,
    Materiais.VERY_FINE :       lambda clay, sand, silt: clay > 60                       ,
    }
