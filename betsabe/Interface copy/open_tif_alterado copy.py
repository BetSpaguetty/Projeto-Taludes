...
class novaJanela(QMainWindow):
    def __init__(self):
        super(novaJanela, self).__init__()
...
class UI(QMainWindow):
    def __init__(self):
        ...
        # self.janelaRio = self.findChild(QWidget,"JanelaRio")
        ...
        # Instancia a outra janela
        self.janelaRio = novaJanela()
