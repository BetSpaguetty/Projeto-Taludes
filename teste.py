...
class AmbienteController :
    ...
    def _associateGraphFilters(self) :
        ...
        self.buttonFilterFos = self.view.matrixViewer.addButtonTop(GraphFilters.FOS.value, checkable=True)
        self.buttonFilterFos.clicked.connect(lambda : self.functionButtonFOS())
        
        self.buttonFilterRugosidade = self.view.matrixViewer.addButtonTop(GraphFilters.RUGOSITY.value, checkable=True)
        self.buttonFilterRugosidade.clicked.connect(lambda : self.functionButtonRugosidade())

        self.buttonFilterHisometric = self.view.matrixViewer.addButtonTop(GraphFilters.FLOWAC.value, checkable=True)
    ...
    def _associateTaludes(self) : 
        matrixElevation = self.mapa.getElevationMatrix()
        self.filterTaludes = FilterFOS(matrixElevation)
