...
class Ui_AppTaludes(object):
    def setupUi(self, AppTaludes):
        ...
        self.horizontalSlider_H.setMinimum(1)
        self.horizontalSlider_H.setMaximum(5)
        self.horizontalSlider_H.setPageStep(1)
        ...
        sizePolicy2.setHeightForWidth(self.hLbl.sizePolicy().hasHeightForWidth())
        self.hLbl.setSizePolicy(sizePolicy2)
        font = QFont()
        ...
        sizePolicy2.setHeightForWidth(self.hwLbl.sizePolicy().hasHeightForWidth())
        self.hwLbl.setSizePolicy(sizePolicy2)
        font1 = QFont()
        ...
        self.gridLayout_3.addWidget(self.horizontalSlider_C, 1, 0, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.oLbl.sizePolicy().hasHeightForWidth())
        self.oLbl.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout_3.addWidget(self.horizontalSlider_Phi, 3, 0, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.cLbl.sizePolicy().hasHeightForWidth())
        self.cLbl.setSizePolicy(sizePolicy2)
        ...
        self.down_Layout.addLayout(self.gridLayout_3)
        ...
        self.gridLayout.addLayout(self.down_Layout, 3, 1, 1, 1)

        self.canvas_Layout = QHBoxLayout()
        self.canvas_Layout.setObjectName(u"canvas_Layout")
        self.canvas_Layout.setSizeConstraint(QLayout.SetNoConstraint)
        self.canvas_Layout.setContentsMargins(0, -1, -1, -1)
        self.horizontalLayout_3 = QHBoxLayout()
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")

        self.canvas_Layout.addLayout(self.horizontalLayout_3)
...
"background-color: rgb(190, 190, 190);")
        ...
        self.widget.setGeometry(QRect(0, 0, 1051, 391))
        ...
        self.gridLayout.addLayout(self.canvas_Layout, 1, 1, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.x1label.sizePolicy().hasHeightForWidth())
        self.x1label.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.x2label.sizePolicy().hasHeightForWidth())
        self.x2label.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.y1label.sizePolicy().hasHeightForWidth())
        self.y1label.setSizePolicy(sizePolicy4)
        ...
        self.y1lineEdit.setAutoFillBackground(False)

        self.middle_Layout.addWidget(self.y1lineEdit)

        self.y2label = QLabel(AppTaludes)
        self.y2label.setObjectName(u"y2label")
        sizePolicy4.setHeightForWidth(self.y2label.sizePolicy().hasHeightForWidth())
        self.y2label.setSizePolicy(sizePolicy4)
        ...
        self.gridLayout.addLayout(self.middle_Layout, 2, 1, 1, 1)
        ...
        self.Adjust.clicked.connect(AppTaludes.figureAdjust)
    ...
    def retranslateUi(self, AppTaludes):
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.tab), QCoreApplication.translate("AppTaludes", u"Inclina\u00e7\u00e3o", None))
        ...
        self.x1lineEdit.setPlaceholderText(QCoreApplication.translate("AppTaludes", u"20", None))
        ...
        self.x2lineEdit.setPlaceholderText(QCoreApplication.translate("AppTaludes", u"50", None))
        ...
        self.y1lineEdit.setPlaceholderText(QCoreApplication.translate("AppTaludes", u"20", None))
        ...
        self.y2lineEdit.setPlaceholderText(QCoreApplication.translate("AppTaludes", u"60", None))
